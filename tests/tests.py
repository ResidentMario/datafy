...
@pytest.mark.parametrize("uri,filename,type_hints,expected", [
    ...
    # ZIPPED BUNDLE WITH MULTIPLE FOLDER LAYERS
    ('mock://www.hraadvisors.com/wp-content/uploads/2014/04/NYC_Tech_Ecosystem_Data1.zip',
     'NYC_Tech_Ecosystem_Data1.zip',
     ('application/zip', 'zip'),
     [{'extension': 'DS_Store',
       'filepath': 'NYC_Tech_Ecosystem_Data/.DS_Store',
       'mimetype': 'application/octet-stream'},
      {'extension': 'csv',
      'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/10_NonTech_Jobs_in_Tech_Firms_by_Occupation.csv',
      'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/1_Industry_Definitions.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/2_Occupation_Definitions.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/3_Ecosystem_by_Industry.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/4_Tech_Jobs_in_Tech_Firms_by_Industry.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/5_Tech_Jobs_in_NonTech_Firms_by_Industry.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/6_NonTech_Jobs_in_Tech_Firms_by_Industry.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/7_Ecosystem_by_Occupation.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/8_Tech_Jobs_in_Tech_Firms_by_Occupation.csv',
       'mimetype': 'text/plain'},
      {'extension': 'csv',
       'filepath': 'NYC_Tech_Ecosystem_Data/CSV_Files/9_Tech_Jobs_in_NonTech_Firms_by_Occupation.csv',
       'mimetype': 'text/plain'},
      {'extension': 'txt',
       'filepath': 'NYC_Tech_Ecosystem_Data/Data_Dictionary.txt',
       'mimetype': 'text/plain'},
      {'extension': 'DS_Store',
       'filepath': 'NYC_Tech_Ecosystem_Data/XLS_File/.DS_Store',
       'mimetype': 'application/octet-stream'},
      {'extension': 'xlsx',
       'filepath': 'NYC_Tech_Ecosystem_Data/XLS_File/NYC_Tech_Ecosystem_Data.xlsx',
       'mimetype': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'}
    ])
])
